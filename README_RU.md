...
**Домашняя страница**
<img width="1920" alt="Домашняя страница" src=".github/images/Gallery.png" />

**Страница просмотра медиа**
<img width="1920" alt="Страница просмотра медиа" src=".github/images/Media.png" />

**Страница публичного медиа**
<img width="1920" alt="Страница публичного медиа" src=".github/images/Shared.png" />

**Панель администратора**
<img width="1920" alt="Панель администратора" src=".github/images/Admin_Panel.png" />
...
- **Связки тегов:** Определяйте взаимосвязи между тегами. Когда целевой тег применяется к медиафайлу, связанные с ним теги также применяются автоматически. 

- **Автоматические теги на основе типа файла:** Предварительно настроенные теги автоматически будут добавлены к каждому загружаемому медиафайлу в зависимости от его типа (изображение, GIF или видео).
...
- **Управление превью:** Сломалось или не создалось превью? Не проблема! Можно легко исправить из админ-панели. Также, вы можете пересоздать превью для всей библиотеки разом.
